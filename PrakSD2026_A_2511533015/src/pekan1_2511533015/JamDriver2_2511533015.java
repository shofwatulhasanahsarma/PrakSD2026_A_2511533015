...
public class JamDriver2_2511533015 {
	...
	public static void main(String[] args) {
		...
		// 1. Input Jam Pertama
		System.out.println("\n--- Input Jam 1 ---");
		Jam_2511533015 j1 = buatJamDariInput(input);
		
		// 2. Input Jam Kedua
		System.out.println ("\n--- Input Jam 2 ---");
		Jam_2511533015 j2 = buatJamDariInput (input);
		...
		System.out.println("Durasi (J1 ke J2) : " + Jam_2511533015.durasiDetik(j1, j2) + " detik");
		
		Jam_2511533015 jNext = j1.nextSecond();
		System.out.println("Jam 1 Detik Berikutnya: " + jNext);
		
		Jam_2511533015 jPrev = j1.prevSecond();
		System.out.println("Jam 1 Detik Sebelumnya: " + jPrev);
		
		// 6. Operasi Penjumlahan Jam
		Jam_2511533015 jHasilPlus = j1.plus(j2);
 ...
 */
private static Jam_2511533015 buatJamDariInput (Scanner sc) {
	int h, m, s;
	while (true) {
		...
		if (Jam_2511533015.isValid(h,  m, s)) {
